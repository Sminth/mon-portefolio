    ...
    >
      <div className="relative w-full  flex flex-col space-y-4">
        ...
        <motion.div
          initial={{opacity:1}}
          animate={{ opacity: 0 }}
          transition={{ opacity: { delay: 2.5, duration: 0.5 } }}
        ...
        >
          ...
          <span className="text-gray-500 text-md">
            <span className="font-bold">Emmanuel Malan </span>
            a {" "}
            {ShowText ? (
              <motion.span
          ...
          <div className="flex flex-col space-y-3">
            <span className="font-Header text-gray-400 text-lg">Essayer:</span>
            <div className="flex flex-col space-y-2 pl-10">
              <span className="text-Header text-gray-400 font-Header sm:text-base text-sm">
                <span className="text-bold text-gray-500">&bull;</span> Vérification de la connexion
              </span>
              <span className="text-Header text-blue-500 font-Header sm:text-base text-sm">
                <span className="text-bold text-gray-500">&bull;</span> Vérification du proxy et du pare-feu
              </span>
              <span className="text-Header text-blue-500 font-Header sm:text-bdase text-sm">
                <span className="text-bold text-gray-500">&bull;</span> Exécution des diagnostics réseau Windows
              </span>
            </div>
          </div>
