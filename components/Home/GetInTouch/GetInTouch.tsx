  ...
  return (
    ...
    >
      ...
      <p className="flex font-Header tracking-wider text-gray-400 text-center px-6 sm:px-16 md:px-0 md:w-[600px]">
        À l&apos;écoute de toute nouvelle opportunité, ma boîte de réception est
        ouverte. Que vous ayez une question ou que vous souhaitiez simplement me
        dire bonjour, je ferai de mon mieux pour vous répondre !
      </p>
      <div className="pt-4">
        <a
          href="mailto:kassi.emmanuelmalan@gmail.com"
          target={"_blank"}
          rel="noreferrer"
        >
          <button
