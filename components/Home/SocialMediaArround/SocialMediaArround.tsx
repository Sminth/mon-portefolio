      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            {/* Github Icon */}
            <IconClickableWithAnimation Icon={GithubIcon} href={"https://github.com/sminth"} />
            {/* Linkedin icon */}
            <IconClickableWithAnimation Icon={LinkedinIcon} href={"https://www.linkedin.com/in/emmanuel-malan/"} />
            {/* Instagram Icon */}
        ...
        <div className="flex flex-col space-y-24 justify-center items-center">
          ...
          >
            <a href="mailto:kassi.emmanuelmalan@gmail.com" target={"_blank"} rel="noreferrer">
              ...
              kassi.emmanuelmalan<span className="text-AAsecondary">@</span>gmail<span className="text-AAsecondary">.</span>com
              </span>
            </a>
          </motion.div>
