    ...
    <div className="font-mono text-xs md:flex hidden flex-row items-center space-x-8 ">
      ...
      >
        <ReactScrollLink to="aboutSection" spy={true} smooth={true} offset={-100} duration={200}>
          &gt; 01. <span className="text-white hover:cursor-pointer hover:text-AAsecondary duration-300">Apropos</span>
        </ReactScrollLink>
      </motion.div>
      <motion.div
        initial={{
      ...
      >
        ...
        &gt; 03. <span className="text-white  hover:cursor-pointer hover:text-AAsecondary duration-300">Réalisations</span>
